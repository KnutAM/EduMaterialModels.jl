...
using Tensors, EduMaterialModels, MaterialModelsBase, PlutoUI

# ╔═╡ 28011c1d-e536-4d86-8337-0f77a9abbfea
...
function plot_response(;Δϵ=0.01, num_steps=100, E=200.e3, Y0=200.0, Hiso=10e3, κ∞=100.0, Hkin=30.e3, β∞=100.0, use_explicit=false)
	...
	mw = use_explicit ? EduMaterialModels.ExplicitWrapper(m) : m
...
begin
	...
	Hi_slider = @bind Hiso Slider(prepend!([1e3*2^n for n in 0:8], 0.0); show_value=true)
	κ∞_slider = @bind κ∞ Slider(50.:50:500; show_value=true)
	Hk_slider = @bind Hkin Slider(prepend!([1e3*2^n for n in 0:8], 0.0); show_value=true)
	β∞_slider = @bind β∞ Slider(50.:50:500; show_value=true)
...
plot_response(;Y0=Y0, Hiso=Hiso, κ∞=κ∞, Hkin=Hkin, β∞=β∞, num_steps=num_steps, use_explicit=method)

# ╔═╡ 00000000-0000-0000-0000-000000000001
PLUTO_PROJECT_TOML_CONTENTS = """
[deps]
CairoMakie = "13f3f980-e62b-5c42-98c6-ff1f3baf88f0"
EduMaterialModels = "dc10c695-e18c-49e2-887a-ef9f22cfa888"
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "15a6141e3a277ac16b94ffae39fb0ad74e37f789"
...
[[deps.Newton]]
deps = ["DiffResults", "ForwardDiff", "LinearAlgebra", "RecursiveFactorization", "StaticArrays"]
git-tree-sha1 = "338eccc29222ce11733741d30e7934a484fd8e59"
